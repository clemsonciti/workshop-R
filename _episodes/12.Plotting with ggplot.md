...
### Working with NetCDF (Network Common Data Format)
Here we will plot the global temperature data set
```
Download NetCDF file [here](ftp://ftp.cdc.noaa.gov/Datasets/cru/hadcrut2/ltm/air.mon.ltm.nc)
